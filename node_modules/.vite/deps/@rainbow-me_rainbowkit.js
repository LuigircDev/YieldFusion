...
import {
  ...
  mini_exports,
  parse
} from "./chunk-XQRWSPLM.js";
import {
  Log_exports,
  TransactionReceipt_exports,
  bls12_381,
  ens_normalize
} from "./chunk-KELIMVQK.js";
import {
  AbiError_exports,
  Base64_exports,
  HDKey,
...
import {
  ...
  useSignMessage,
  useSwitchChain
} from "./chunk-2NOHTVQV.js";
import "./chunk-EDDRWZDP.js";
import "./chunk-7O7OV3WR.js";
...
import {
  mainnet
} from "./chunk-FH27GAYH.js";
import "./chunk-WFH5C7WV.js";
import {
...
(function(Cuer2) {
  ...
  function Root(props) {
    const { children, size: size4 = "100%", value, version: version5, errorCorrection, ...rest } = props;
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-HDPON2QB.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-Y3UQO2ZT.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-RWD67I2P.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-VGYAKVBA.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-ZC2SSUR6.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-E5JZFZQF.js");
